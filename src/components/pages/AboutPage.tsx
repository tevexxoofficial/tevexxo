...
import { usePublicSettings } from "@/hooks/useTevexxoApi";
...
const values = [
  {
    ...
    body: "Curriculum measured by the roles our learners land, not the hours they sit.",
  },
  {
    icon: Users,
    title: "Mentor-led",
    body: "Every cohort is guided by engineers and designers working in the field today.",
  },
  {
    icon: Award,
    title: "Certification",
    body: "Industry-recognized completion certificates plus placement support.",
  },
  {
    icon: BookOpen,
    title: "Always current",
    body: "Programs refresh every quarter to track real industry demand.",
  },
];
